...
class Solution:
    def depthSum(self, nestedList: List[NestedInteger]) -> int:
        def dfs(nl: List[NestedInteger], depth):
            ...
            # recurrence relation
            sm = 0
            # BUG: TypeError: 'method' object is not iterable
            for e in nl:
                if e.isInteger():
...
NestedInteger{_integer: None, _list: [NestedInteger{_integer: 1, _list: []}, NestedInteger{_integer: 2, _list: []}, NestedInteger{_integer: 3, _list: []}]}
