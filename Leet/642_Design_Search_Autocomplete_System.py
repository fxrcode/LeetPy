...
Lookback:
+ OOD + clean code, comment, very important in hard, complicated code, to not loss mind track.
...
class AutocompleteSystem:
    """
    Runtime: 608 ms, faster than 78.95% of Python3 online submissions for Design Search Autocomplete System.
