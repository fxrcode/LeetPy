...
class Solution:
    def findCheapestPrice(
        ...
        def wangQuic():
            """
            Runtime: 281 ms, faster than 29.64% of Python3 online submissions for Cheapest Flights Within K Stops.

            https://leetcode.com/problems/cheapest-flights-within-k-stops/discuss/267200/Python-Dijkstra
            use vis(n) to keep search space small
            """
            AL = defaultdict(dict)
        ...
        def dijkstra_OS_WA():
            ...
            WA for
            9
            [[0,1,1],[1,2,1],[2,3,1],[3,7,1],[0,4,3],[4,5,3],[5,7,3],[0,6,5],[6,7,100],[7,8,1]]
            0
            8
            3
